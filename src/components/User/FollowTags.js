    ...
    .map((tag, index) => {
      return (
        <Col xl={3} lg={4} md={4} sm={6} key={index}>
          ...
          >
            <Image src={tag.logo} style={{ width: "6rem", height: "6rem" }} />
            <Card.Body style={{ padding: "0", margin: "10px" }}>
              ...
              <Card.Text className="d-flex" style={{ flexDirection: "column" }}>
                <span>
                ...
                <Button variant="info" onClick={() => changeFollow(tag.id_tag)}>
                  <i className="fas fa-rss-square">
                    &nbsp;
                    {tag.status === true ? "Đang theo dõi" : "Theo dõi"}
                  </i>
                </Button>
              </Card.Text>
            </Card.Body>
