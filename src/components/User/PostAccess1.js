...
const PostAccess1 = () => {
  ...
  const postAccess = useSelector(postUserSelect1);
          ...
          <Card.Body>
            ...
            <div className="footer-card">
              <OverlayTrigger
                ...
                overlay={(props) => (
                  <Tooltip {...props}>Chuyển sang riêng tư</Tooltip>
                )}
                placement="bottom"
              >
                <Button
              ...
              <OverlayTrigger
                delay={{ hide: 100, show: 100 }}
                overlay={(props) => (
                  <Tooltip {...props}>Ẩn link bài viết</Tooltip>
                )}
                placement="bottom"
              >
                <Button
