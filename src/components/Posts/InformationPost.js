...
const InformationPost = () => {
  ...
  return (
    <>
      ...
      >
        <h2 className="title-information letter">
            ...
            <Col xl={12} lg={6} md={6}>
              ...
              >
                <div className="d-flex align-items-center">
                  ...
                  <span className="info-title" style={{ color: "#146ebe" }}>
              ...
              >
                <div className="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <p>
                      {user.total_vote_up
                        ? user.total_vote_up - user.total_vote_down
                        : user.total_vote_up}
                    </p>
                  </div>
                </div>
            ...
            <Col xl={12} lg={6} md={6}>
              ...
              >
                <div className="d-flex align-items-center">
                  ...
                  <span className="info-title" style={{ color: "#146ebe" }}>
                    <i className="fas fa-rss-square fa-3x"></i>
                  </span>
                  &nbsp;
                  <div>
