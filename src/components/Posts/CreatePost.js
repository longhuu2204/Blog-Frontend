...
const CreatePost = () => {
  ...
  const onChangeSubmitPost = (event) => {
    ...
    dispatch(addPost(post)).then((result) => {
      if (result.payload.message === "Thao tác thành công") {
    ...
    return (
      <components.Menu {...props}>
        {optionSelectedLength < 5 ? (
          ...
          <div style={{ margin: 15 }}>Tối đa chỉ được 5 thẻ thôi bạn ơi!</div>
        )}
      </components.Menu>
    );
  };
      ...
      <Container fluid style={{ marginTop: "75px" }}>
        <Row>
          ...
          <Col md={10}>
            ...
            <Form className="box-write-post" onSubmit={onChangeSubmitPost}>
              <select
                name="access"
                style={{ float: "right" }}
                value={access}
              ...
              >
                ...
                <option value={2}>&nbsp;Bất kì ai có liên kết&nbsp;</option>
