  ...
  if (localStorage[types.LOCAL_STORAGE_TOKEN_NAME]) {
    changeLoginToLogout = (
      <Dropdown.Menu align={{ md: "end" }}>
        ...
        <Dropdown.Item as={Link} to="/" onClick={() => dispatch(setLogout())}>
          Đăng xuất
        </Dropdown.Item>
      </Dropdown.Menu>
    );
              ...
              {localStorage[types.LOCAL_STORAGE_TOKEN_NAME] ? (
                <>
                  ...
                  {id_role !== 3 ? (
                    <Dropdown>
                      ...
                      <Dropdown.Menu align={{ md: "end" }} className="a">
                        <Dropdown.Item as={Link} to="/moderator/users">
                          Quản lý người dùng
                        </Dropdown.Item>
                        <Dropdown.Item as={Link} to="/moderator/tags">
                          Quản lý thẻ
                        </Dropdown.Item>
                        <Dropdown.Item as={Link} to="/moderator/posts">
                          Quản lý bài viết
                        </Dropdown.Item>
                        <Dropdown.Item as={Link} to="/moderator/feedback">
                          Quản lý phản hồi
                        </Dropdown.Item>
                      </Dropdown.Menu>
                    </Dropdown>
                  ...
                  <Dropdown>
                    ...
                    <Dropdown.Menu align={{ md: "end" }}>
                      <Dropdown.Item as={Link} to="/publish/post">
                        Viết bài
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
